...
(function () {
  ...
  var DICT = {
    ...
    'Home / Farmer / My Profile':'होम / किसान / मेरी प्रोफ़ाइल',
    'My profile':'मेरी प्रोफ़ाइल',

    '← Back home':'← होम पर वापस जाएँ',
    'Back home':'होम पर वापस जाएँ',
    'Home':'होम',
    'Log out':'लॉग आउट',
    'Dashboard':'डैशबोर्ड',
    ...
    'Status management':'स्थिति प्रबंधन',
    'Reports':'रिपोर्ट',
    'Reports and Analytics':'रिपोर्ट और विश्लेषण',
    'Reports & Analytics':'रिपोर्ट्स और विश्लेषण',

    'Notifications':'सूचनाएँ',
    'Alerts & centre announcements':'अलर्ट और केंद्र घोषणाएँ',
    'Live queue':'लाइव कतार',
    'Centre finder':'केंद्र खोजें',

    'Book a procurement slot':'खरीद स्लॉट बुक करें',
    'Book a slot':'स्लॉट बुक करें',
    'Booking token':'बुकिंग टोकन',
    ...
    'Search manually':'मैन्युअल रूप से खोजें',

    'Choose a procurement centre':'खरीद केंद्र चुनें',
    'Choose a date':'तारीख चुनें',
    'Available time slots':'उपलब्ध समय स्लॉट',
    'Review your booking':'अपनी बुकिंग की समीक्षा करें',

    'Produce details':'उपज विवरण',
    'Crop / produce type':'फसल / उपज का प्रकार',
    'Select crop':'फसल चुनें',
    'Please select your crop type':'कृपया अपनी फसल का प्रकार चुनें',

    'Quantity (quintal)':'मात्रा (क्विंटल)',
    'Quantity (quintals)':'मात्रा (क्विंटल)',
    'Enter your expected quantity':'अपेक्षित मात्रा दर्ज करें',
    'Enter quantity before selecting a centre.':'केंद्र चुनने से पहले मात्रा दर्ज करें।',
    ...
    'View my token':'मेरा टोकन देखें',

    'Confirm this booking?':'इस बुकिंग की पुष्टि करें?',
    'Once confirmed, you\'ll receive a token for this slot.':
      'पुष्टि के बाद आपको इस स्लॉट के लिए टोकन मिलेगा।',

    'Loading…':'लोड हो रहा है…',
    'Loading...':'लोड हो रहा है...',
    'Loading your booking…':'आपकी बुकिंग लोड हो रही है…',
    'Loading your status…':'आपकी स्थिति लोड हो रही है…',
    'Loading your booking...':'आपकी बुकिंग लोड हो रही है...',
    'Loading your booking':'आपकी बुकिंग लोड हो रही है',
    'Loading crops...':'फसलें लोड हो रही हैं...',
    'Loaded':'लोड हो गया',
    'Loading state':'लोडिंग स्थिति',
    'Empty-day state':'खाली-दिन स्थिति',

    'tokens ahead of you':'आपसे आगे टोकन',
    'Ahead of you':'आपसे आगे',
    'This centre today':'आज इस केंद्र पर',
    ...
    'Couldn\'t load notifications':'सूचनाएँ लोड नहीं हो सकीं',
    ...
    'Book your procurement slot. Skip the wait.':
      'अपना खरीद स्लॉट बुक करें। इंतज़ार छोड़ें।',
    ...
    'No more standing in line for hours without knowing when your turn will come. Book a slot, get a token, and track your status — all from your phone.':
      'अब घंटों लाइन में खड़े रहने की ज़रूरत नहीं। स्लॉट बुक करें, टोकन पाएं और अपनी स्थिति अपने फोन से ट्रैक करें।',

    'Start booking →':'बुकिंग शुरू करें →',
    'Check my status':'मेरी स्थिति देखें',
    ...
    'Register once':'एक बार पंजीकरण करें',
    ...
    'Pick a centre, date, and time that works for you. Get an instant digital token.':
      'अपने लिए सुविधाजनक केंद्र, तारीख और समय चुनें। तुरंत डिजिटल टोकन पाएं।',

    'Track your status':'अपनी स्थिति ट्रैक करें',
    ...
    'Select crop and quantity first':'पहले फसल और मात्रा चुनें',
    ...
    'PASSWORD (hashed on the server; never stored in the browser)':
      'पासवर्ड (सर्वर पर हैश किया जाता है; ब्राउज़र में कभी संग्रहीत नहीं होता)',

    'Password':'पासवर्ड',
    'Show':'दिखाएँ',

    'Use letters and numbers. Do not use your mobile number.':
      'अक्षरों और संख्याओं का उपयोग करें। अपना मोबाइल नंबर न इस्तेमाल करें।',
    ...
    'Continue to slot booking':'स्लॉट बुकिंग पर जाएँ',

    'Keep me logged in on this device':
      'इस डिवाइस पर मुझे लॉगिन रखें',

    'New to Kisan Queue?':'Kisan Queue पर नए हैं?',
    ...
    'Generate my token':'मेरा टोकन बनाएँ',
    ...
    'Medium':'मध्यम',
    'Low':'कम',
    'Selected centre':'चयनित केंद्र',
    '2 hours ago':'2 घंटे पहले',
    'Yesterday':'कल',
    '3 days ago':'3 दिन पहले',
    'Timing change this week':'इस सप्ताह समय में बदलाव',
    'New quality check process':'नई गुणवत्ता जाँच प्रक्रिया',
    'All centres':'सभी केंद्र',
    'No alerts right now':'अभी कोई अलर्ट नहीं है',

    /* OPERATIONS */

    'Today\'s Operations':'आज का संचालन',
    'Bookings today':'आज की बुकिंग',
    'Farmers waiting':'प्रतीक्षा कर रहे किसान',
    'Avg wait 22 min':'औसत प्रतीक्षा 22 मिनट',
    'Active counters':'सक्रिय काउंटर',
    'Completed today':'आज पूर्ण',
    'Pending cases':'लंबित मामले',
    'Needs review':'समीक्षा आवश्यक',
    'Bookings by hour':'घंटे के अनुसार बुकिंग',
    'Issue':'समस्या',
    'Pending':'लंबित',
    ...
    '12 more than yesterday':'कल से 12 अधिक',
    '71% of today\'s bookings':'आज की बुकिंग का 71%',
    'Counter 3 offline':'काउंटर 3 बंद है',
    ...
    'Currently serving':'वर्तमान में सेवा',
    'Waiting queue':'प्रतीक्षा कतार',
    'On hold':'होल्ड पर',
    'Escalate token':'टोकन एस्केलेट करें',

    'Flag this booking for supervisor review.':
      'इस बुकिंग को सुपरवाइज़र समीक्षा के लिए चिन्हित करें।',

    'Reason':'कारण',
    'Weighing discrepancy':'वजन में अंतर',
    'Quality dispute':'गुणवत्ता विवाद',
    'Payment not confirmed':'भुगतान की पुष्टि नहीं',
    'Farmer dispute':'किसान विवाद',
    'Other':'अन्य',
    'Note (optional)':'नोट (वैकल्पिक)',
    'Escalate':'एस्केलेट करें',
    'Mark as complete':'पूर्ण चिह्नित करें',
    ...
    'Move each booking through checked-in, quality check, weighing, and acceptance.':
      'हर बुकिंग को चेक-इन, गुणवत्ता जाँच, वजन और स्वीकृति के चरणों से आगे बढ़ाएँ।',

    'Active bookings':'सक्रिय बुकिंग',
    'Needs attention':'ध्यान आवश्यक',
    'Flag an issue':'समस्या चिन्हित करें',

    'This will pause the booking for supervisor review.':
      'इससे बुकिंग सुपरवाइज़र समीक्षा तक रोक दी जाएगी।',

    'Quality below standard':'गुणवत्ता मानक से कम',
    'Documentation mismatch':'दस्तावेज़ में असंगति',
    'Flag issue':'समस्या चिन्हित करें',
    ...
    'Completed procurements':'पूर्ण खरीद',
    'Payment pending':'भुगतान लंबित',
    'Across all centres':'सभी केंद्रों में',

    'Bookings trend — by hour':
      'बुकिंग ट्रेंड — घंटे के अनुसार',

    'Centre utilization':'केंद्र उपयोगिता',
    ...
    '12 more than previous period':'पिछली अवधि से 12 अधिक',
    '3 min less than previous period':'पिछली अवधि से 3 मिनट कम',
    '71% of total bookings':'कुल बुकिंग का 71%',
    ...
    'हिंदी (Hindi)':'हिंदी',
    'Display and accessibility':'डिस्प्ले और सुगम्यता',
    ...
    'Centre announcements':'केंद्र घोषणाएँ',

    'Closures, delays, and weather-related advisories.':
      'बंद रहने, देरी और मौसम संबंधी सलाह।',

    'Help and FAQ':'सहायता और FAQ',
    'App information':'ऐप जानकारी',
    'Portal':'पोर्टल',
    'Version':'संस्करण',
    'Assigned centre from staff account':'स्टाफ खाते से निर्धारित केंद्र',
    'Data mode':'डेटा मोड',
    'Connected staff portal':'कनेक्टेड स्टाफ पोर्टल',
    ...
    'Today\'s Market Prices':'आज के बाज़ार भाव',
    'Today\'s Market Price':'आज का बाज़ार भाव',
    'Market price':'बाज़ार भाव',
    'Market prices':'बाज़ार भाव',
    'Price':'भाव',
    'Prices':'भाव',
    'Crop prices':'फसल के भाव',
    ...
    'Nearest centre':'निकटतम केंद्र',
    'Selected crop':'चयनित फसल',
    'Selected quantity':'चयनित मात्रा',
    ...
    'Refresh queue':'कतार रिफ्रेश करें',
    ...
    'Recall':'फिर से बुलाएँ',
    'Resume':'फिर शुरू करें',
    'Hold':'होल्ड',
    'Complete':'पूर्ण करें',
    'Skip':'छोड़ें',
    'Serve':'सेवा शुरू करें',
    'Call':'बुलाएँ',
    ...
    'Kisan Procurement Centre':'किसान खरीद केंद्र',
    'procurement centre':'खरीद केंद्र',
    'Procurement Centre':'खरीद केंद्र',
    'Centre Operator':'केंद्र ऑपरेटर',

    /* NAMES / SAMPLE DATA */

    'Ramesh Kumar':'रमेश कुमार',
    'Suresh Yadav':'सुरेश यादव',
    'Kheri Village':'खेड़ी गाँव'
  };
   ...
   * This lets us switch back and forth without
   * translating already-translated Hindi again.
   */
  ...
  /*
   * Keep spaces/newlines around translated text.
   */
  ...
  function buildEntries(map) {
    return Object.keys(map)
      .filter(function (key) {
        return key && map[key] && key !== map[key];
      })
      .sort(function (a, b) {
  ...
  var enPhrases = buildEntries(DICT);
  var hiPhrases = buildEntries(reverse);

  /*
   * Translate known phrases even when they are
   * part of a larger sentence.
   */
  function replacePhrases(text, phrases, map) {
    var out = String(text);

    phrases.forEach(function (key) {
      var value = map[key];
      ...
      /*
       * Don't replace a word in the middle of
       * another word.
       *
       * Example:
       * "Open" will not change "Opened".
       */
      var start =
        /^[A-Za-z0-9]/.test(key)
          ? '\\b'
  ...
  function direct(s, lang) {
    ...
    if (lang === 'hi') {
      ...
      /*
       * Then translate known phrases inside
       * a larger/dynamic string.
       */
  ...
  function capture(root, currentLang) {
    ...
    while ((t = walker.nextNode())) {
      ...
      if (!originalText.has(t)) {
        ...
        /*
         * If content was created while Hindi
         * was active, try to recover its
         * English original.
         */
        originalText.set(
          t,
  ...
  function translateRoot(root, lang) {
    ...
    while ((t = walker.nextNode())) {
      ...
      /*
       * Never translate the language selector.
       */
      if (
        p.closest &&
        p.closest('.kq-i18n-control')
      ) {
        continue;
      }
    ...
    els.forEach(function (el) {
      ...
      /*
       * Only translate input values when
       * they are actual buttons.
       *
       * Normal text fields are NOT changed.
       */
      if (
        a.value !== null &&
        el.tagName === 'INPUT' &&
  ...
  function apply(lang, root) {
    ...
    /*
     * Keep any existing language select
     * synchronized.
     */
    document
      .querySelectorAll(
  ...
  /*
   * Create the bottom-left language control
   * only if the page does not already have one.
   */
