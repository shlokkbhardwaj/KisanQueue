...
(function (global) {
  ...
  var LEGACY_FARMER_KEY = 'Kisan Queue_farmer';
  ...
  function readFrom(storage) {
    try {
      ...
      if (!session || !session.token || !session.farmer) {
  ...
  KQ.getSession = function () {
    return (
      readFrom(global.localStorage) ||
      readFrom(global.sessionStorage)
    );
  };

  KQ.isLoggedIn = function () {
  ...
  KQ.requireLogin = function () {
    ...
    KQ.api('/auth/me')
      ...
      .catch(function () {
        /* network errors handled by page loading states */
      });
  ...
  KQ.pickCurrentBooking = function (
    bookings
  ) {
    var list = (
      bookings || []
      ...
      function (resolve, reject) {
        if (
          ...
          return reject(
            KQError(
              'geo',
              'This browser does not support location. Please choose a centre manually.',
              {
                code: 'UNSUPPORTED'
              }
            )
            ...
            reject(
              KQError(
                ...
                messages[
                  ...
                  'Location is not available. You can still choose a centre manually.',
                {
                  code: err.code
                }
              )
