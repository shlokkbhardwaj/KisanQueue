...
import { staffAnalytics } from '../controllers/staffAnalytics.controller.js';
...
router.get('/prices', asyncHandler(listPrices));
...
router.get('/staff/analytics', requireStaffAuth, asyncHandler(staffAnalytics));
